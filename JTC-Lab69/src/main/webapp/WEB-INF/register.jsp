...
<html>
<body>
	<form:form action="registerStudent.jtc" method="post"
			...
			<tr>
				...
				<td><form:checkbox path="timings" value="07.30A.M - 09.30A.M" />
					07.30A.M - 09.30A.M <br> <form:checkbox path="timings"
						...
						path="timings" value="04.00A.M - 06.00P.M" /> 04.00A.M - 06.00P.M
					<br> <form:checkbox path="timings" value="06.30A.M - 08.30P.M" />
					06.30A.M - 08.30P.M <br> <form:checkbox path="timings"
